...
public class PlatformCanvas extends Canvas implements IPlatformCanvas, Runnable, CommandListener
{
    ...
    private static final long BACKLIGHT_THREAD_SLEEP = 3000;
    private static final int BACKLIGHT_DURATION = 6000;
    ...
    public void run()
    {
        while (true)
        {
            try
            {
                if (backlight)
                {
                    engine.getDisplay().flashBacklight(BACKLIGHT_DURATION);
                }
